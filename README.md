...
- The template downloads the latest release by default. For reproducible VM setup, pin a known-good runtime release with `--set '.param.RUNTIME_RELEASE="v0.1.0-moonsphere.4"'`.
